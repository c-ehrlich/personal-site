  ...
  return (
    <PageSectionContainer>
      <>
        ...
        <h1>A quick intro</h1>
        <p>
          After Graduating from Central St Martins I worked for designers such
          as{' '}
          <Link href='https://aitorthroup.com/'>
            <a>Aitor Throup</a>
          </Link>{' '}
          and{' '}
          <Link href='https://www.janjanvanessche.com/'>
            Jan-Jan van Essche
          </Link>
        ...
        <p>
          During the Coronavirus pandemic I rediscovered my childhood interest
